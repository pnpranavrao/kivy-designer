...
This is my mod of the inspector module.All warnings apply as before.
Make sure you modify your ~/.kivy/config.ini file to include this module.
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            Button:
                ...
                size_hint_x: None
                width: 50
                on_release: root.show_options_remove()
    ...
    def find_parent(self,root,widget):
        for child in root.children:
            if widget in child.children:
                return child
        return self.find_parent(child,widget)
